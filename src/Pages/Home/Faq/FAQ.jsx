...
const FAQ = () => {
    return (
      <section className="py-12 mb-16  px-6 md:px-12 bg-gray-100 rounded-xl ">
        <div className="">
        ...
        <div className="space-y-2 ">
          ...
          <div className="bg-base-100 border  border-base-300 collapse">
            ...
            <div className="collapse-content bg-primary text-primary-content peer-checked:bg-[#412ad5ce] peer-checked:text-secondary-content">
              Each scholarship has specific eligibility criteria, such as
              academic performance, financial need, or extracurricular
              achievements. Check the eligibility requirements on each
          ...
          <div className="bg-base-100 border border-base-300 collapse">
            ...
            <div className="collapse-content bg-primary text-primary-content peer-checked:bg-[#412ad5ce] peer-checked:text-secondary-content">
              ...
              proof of financial need, identification, recommendation letters,
              and a personal statement. Check each scholarship's details page
          ...
          <div className="bg-base-100 border border-base-300 collapse">
            ...
            <div className="collapse-content bg-primary text-primary-content peer-checked:bg-[#412ad5ce] peer-checked:text-secondary-content">
              Each scholarship has a different deadline, which is displayed on
              the scholarship details page. Be sure to submit your application
          ...
          <div className="bg-base-100 border border-base-300 collapse">
            ...
            <div className="collapse-content bg-primary text-primary-content peer-checked:bg-[#412ad5ce] peer-checked:text-secondary-content">
              ...
              extracurricular activities, and the quality of the application.
              Some scholarships may also require an interview or additional
              evaluation.
            </div>
          </div>
